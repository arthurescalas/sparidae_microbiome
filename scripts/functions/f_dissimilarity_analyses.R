...
get_hn_div <- function(ps, dir_tree) {
  ...
  saveRDS(tree_phylog, file = paste0(dir_save, "phylo_tree_phylog.rds"))
  # tree_phylog <- readRDS(paste0(dir_save, "phylo_tree_phylog.rds"))
